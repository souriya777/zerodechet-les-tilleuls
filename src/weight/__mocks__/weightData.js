...
export const VALID_BEGIN_TIMESTAMP = generateFirebaseTimestampFromString('2019-05-02')
export const VALID_END_TIMESTAMP = generateFirebaseTimestampFromString('2019-05-09')